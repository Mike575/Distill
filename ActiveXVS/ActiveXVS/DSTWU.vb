Public Class DSTWU
    ...
    Public DSTWU_StageMulR As New ArrayList


    Sub DSTWU_Variable_Transfer（）
        On Error GoTo ErrorHandler
        myDSTWU.ihApsim.Tree.Data.Streams.FEED.Input.FLOW.MIXED.YIBEN.value = Me.Lightkey_feed_MassFrac  '0.3
        myDSTWU.ihApsim.Tree.Data.Streams.FEED.Input.FLOW.MIXED.BENYIXI.value = Me.Heavykey_feed_MassFrac '0.7
        myDSTWU.ihApsim.Tree.Data.Blocks.B1.Input.RECOVL.value = Me.Lightkey_Up_MassFrac '0.998
        myDSTWU.ihApsim.Tree.Data.Blocks.B1.Input.RECOVH.value = Me.Heavykey_Up_MassFrac  '0.001
        myDSTWU.ihApsim.Tree.Data.Streams.FEED.Input.PRES.MIXED.value = Me.Pressure_feed    '1.1
        myDSTWU.ihApsim.Tree.Data.Streams.FEED.Input.TEMP.MIXED.value = Me.Temperature_feed   '30
        myDSTWU.ihApsim.Tree.Data.Streams.FEED.Input.TOTFLOW.MIXED.value = Me.velocity_feed   '1000

        myDSTWU.ihApsim.Tree.Data.Blocks.B1.Input.PBOT.value = Me.Pressure_Bottom     '1.1
        myDSTWU.ihApsim.Tree.Data.Blocks.B1.Input.PTOP.value = Me.Pressure_Top     '1.0
        myDSTWU.ihApsim.Tree.Data.Blocks.B1.Input.RR.value = Me.Reflux_Ratio      '-1.5
        myDSTWU.ihApsim.Tree.Data.Blocks.B1.Input.LOWER.value = Me.StartStage    '90  
        myDSTWU.ihApsim.Tree.Data.Blocks.B1.Input.UPPER.value = Me.EndStage    '200
        Exit Sub
ErrorHandler:
    ...
    Function MinAcceleratePoint(X As ArrayList, Y As ArrayList) As Integer
        ...
        Do While (i < DSTWU_Stage.Count - 2)
            ...
            MaxAccelerate_plusONE = (DSTWU_R(i) + DSTWU_R(i + 2)) - 2 * DSTWU_R(i + 1)      'i+2
    ...
    Public Sub Transfer_DSTWU_NTR(ByVal ihApsim As IHapp)
        ...
        For Each ihStage In ihNStage
            ...
            DSTWU_StageMulR.Add(DSTWU_Stage(i) * DSTWU_R(i))
            i = i + 1
        Next ihStage
        Exit Sub
ErrorHandler:
